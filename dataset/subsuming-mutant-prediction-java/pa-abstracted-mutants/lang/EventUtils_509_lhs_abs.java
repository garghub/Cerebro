...
try {
MethodUtils . invokeMethod ( eventSource , lr_1 + listenerType . getSimpleName () , listener ) ;
...
final L listener = listenerType . cast ( Proxy . newProxyInstance ( target . getClass () . getClassLoader () , MST[ArgumentPropagationMutator]MSP[]
