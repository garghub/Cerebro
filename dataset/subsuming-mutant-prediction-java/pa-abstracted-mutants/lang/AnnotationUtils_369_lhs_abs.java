...
for ( final Class < ? > iface : ClassUtils . getAllInterfaces ( cls ) ) { MST[NonVoidMethodCallMutator]MSP[]
...
return new StringBuilder ( annotationType == null ? lr_2 : annotationType . getName () )
. insert ( 0 , '@' ) . toString () ;
}
@Override
...
Validate . notNull ( type , lr_3 , a1 ) ;
Validate . notNull ( type2 , lr_3 , a2 ) ;
