...
if ( digit < 0 ) {
throw new IllegalArgumentException ( lr_1 + hexDigit + lr_2 ) ;
}
return digit ;
}
...
if ( src . length > 8 ) {
throw new IllegalArgumentException ( lr_4 + src . length ) ;
}
if ( src . length - srcPos < 4 ) {
throw new IllegalArgumentException ( lr_5 + src . length + lr_6 + srcPos ) ;
}
if ( src [ srcPos + 3 ] ) {
if ( src [ srcPos + 2 ] ) {
if ( src [ srcPos + 1 ] ) {
...
throw new IllegalArgumentException ( lr_7 + nibble ) ;
}
return c ;
}
