...
return cs1 . length () == cs2 . length () && CharSequenceUtils . regionMatches ( cs1 , false , 0 , cs2 , 0 , cs1 . length () ) ; MST[RemoveConditionalMutator_EQUAL_IF]MSP[N]
}
...
return new IllegalStateException ( charsetName + lr_1 + e ) ;
}
