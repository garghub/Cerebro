...
final String resName = String . format ( lr_4 , lang ) ;
return new Scanner ( Resources . getInputStream ( resName ) , ResourceConstants . ENCODING ) ;
}
...
return getInstance ( nameType , rt , LanguageSet . from ( new HashSet <> ( Arrays . asList ( lang ) ) ) ) ; MST[NonVoidMethodCallMutator]MSP[N]
}
