public static SSLContext createSSLContext ( final String protocol , final KeyManager keyManager , final TrustManager trustManager ) MST[RemoveConditionalMutator_EQUAL_ELSE]MSP[N]
throws IOException {
