...
System . out . println ( lr_15 + numberFormat . format ( message . getRootDelayInMillisDouble () ) MST[experimental.NakedReceiverMutator]MSP[]
...
System . out . println ( lr_26 + destNtpTime + lr_22 + destNtpTime . toDateString () ) ;
info . computeDetails () ;
