...
@Deprecated
public boolean append ( final String mailboxName , final String flags , final String datetime ) throws IOException MST[RemoveConditionalMutator_EQUAL_ELSE]MSP[]
{
