...
if ( ! first . getName () . startsWith ( lr_4 ) ) {
System . out . println ( lr_5 + rl1 ) ;
}
if ( one < firstl ) {
first = lst [ one ++ ] ;
}
} else {
System . out . println ( lr_6 + rl2 ) ;
if ( two < secondl ) {
second = mlst [ two ++ ] ;
}
}
...
final TimeZone UTC = TimeZone . getTimeZone ( lr_7 ) ;
