...
public void setEnabledProtocols ( final String [] protocolVersions ) MST[RemoveConditionalMutator_EQUAL_ELSE]MSP[N]
{
...
{
if ( ! SMTPReply . isPositiveCompletion ( sendCommand ( lr_2 ) ) )
{
return false ;
}
performSSLNegotiation () ;
