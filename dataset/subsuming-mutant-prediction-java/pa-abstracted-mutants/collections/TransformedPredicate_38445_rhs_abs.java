...
return new TransformedPredicate <> ( Objects . requireNonNull ( transformer , lr_1 ) ,
Objects . requireNonNull ( predicate , lr_2 ) ) ;
}
@Override
public boolean evaluate ( final T object ) {
final T result = iTransformer . transform ( object ) ; MST[ArgumentPropagationMutator]MSP[S]
