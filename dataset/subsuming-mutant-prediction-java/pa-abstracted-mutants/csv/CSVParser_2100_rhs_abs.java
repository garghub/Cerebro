...
result = new CSVRecord ( this . record . toArray ( new String [ this . record . size () ] ) , this . headerMap , comment , MST[NonVoidMethodCallMutator]MSP[N]
this . recordNumber ) ;
}
return result ;
}
