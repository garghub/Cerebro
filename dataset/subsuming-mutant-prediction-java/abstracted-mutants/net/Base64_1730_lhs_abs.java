...
public static byte [] fn_13 ( final byte [] vr_21 , final boolean vr_27 , final boolean vr_28 , MST[RemoveConditionalMutator_EQUAL_IF]MSP[]
final int vr_30 ) {
...
public byte [] fn_7 ( final byte [] vr_23 ) {
fn_22 () ;
if ( vr_23 == null || vr_23 . length == 0 ) {
return vr_23 ;
}
