...
private static int fn_3 ( final String line , final tp_2 vr_8 ) throws IOException { MST[RemoveConditionalMutator_EQUAL_ELSE]MSP[S]
if ( fn_2 ( line ) ) {
return vl_5 ;
}
...
public static boolean fn_7 ( final int vr_11 ) {
return vr_11 == vl_7 ;
}
