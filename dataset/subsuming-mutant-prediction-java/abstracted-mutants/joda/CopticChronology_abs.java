...
return vr_15 == null ?
fn_2 ( vr_1 . vr_11 , vr_16 ) :
fn_2 ( vr_15 . vr_17 () , vr_16 ) ;
}
public tp_4 fn_6 () {
return vl_1 ;
}
...
@Override
boolean fn_8 ( long vr_18 ) {
return fn_9 () . get ( vr_18 ) == 6 && fn_10 () . fn_11 ( vr_18 ) ;
}
long fn_12 ( int vr_19 ) {
int vr_20 = vr_19 - 1687 ;
int vr_21 ;
if ( vr_20 <= 0 ) {
vr_21 = ( vr_20 + 3 ) >> 2 ;
} else {
...
long vr_22 = ( vr_20 * 365L + vr_21 )
* ( long ) vr_23 . vr_24 ;
return vr_22 + ( 365L - 112 ) * vr_23 . vr_24 ;
}
int fn_14 () {
return vl_2 ;
}
...
long fn_16 () {
return ( 1686L * vl_4 + 112L * vr_23 . vr_24 ) / 2 ;
}
protected void fn_17 ( tp_5 vr_25 ) {
if ( fn_4 () == null ) {
super . fn_17 ( vr_25 ) ;
vr_25 . vr_19 = new fn_18 ( this , vr_25 . vr_19 ) ;
vr_25 . vr_26 = new fn_18 ( this , vr_25 . vr_26 ) ;
vr_25 . vr_27 = vl_5 ;
vr_25 . fn_10 = new fn_19 ( this , 13 ) ;
vr_25 . vr_28 = vr_25 . fn_10 . vr_29 () ;
}
}
