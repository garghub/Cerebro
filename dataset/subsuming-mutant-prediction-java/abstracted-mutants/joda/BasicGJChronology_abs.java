...
long fn_12 ( long vr_11 , long vr_12 ) {
int vr_13 = fn_13 ( vr_11 ) ;
int vr_14 = fn_13 ( vr_12 ) ;
long vr_15 = vr_11 - fn_6 ( vr_13 ) ;
long vr_16 = vr_12 - fn_6 ( vr_14 ) ;
if ( vr_16 >= vl_1 ) {
if ( fn_7 ( vr_14 ) ) {
if ( ! fn_7 ( vr_13 ) ) {
vr_16 -= vr_17 . vr_18 ;
}
} else if ( vr_15 >= vl_1 && fn_7 ( vr_13 ) ) {
vr_15 -= vr_17 . vr_18 ;
}
}
int vr_19 = vr_13 - vr_14 ;
if ( vr_15 < vr_16 ) {
vr_19 -- ;
}
return vr_19 ;
}
long fn_14 ( long vr_1 , int vr_3 ) {
int vr_20 = fn_13 ( vr_1 ) ;
int vr_21 = fn_15 ( vr_1 , vr_20 ) ;
int vr_22 = fn_16 ( vr_1 ) ;
if ( vr_21 > ( 31 + 28 ) ) {
if ( fn_7 ( vr_20 ) ) {
if ( ! fn_7 ( vr_3 ) ) {
vr_21 -- ;
