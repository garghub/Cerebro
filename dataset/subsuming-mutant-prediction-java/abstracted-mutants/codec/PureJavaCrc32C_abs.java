@Override
public long fn_1 () {
final long vr_1 = vl_1 ;
return ( ~ vr_1 ) & 0xffffffffL ;
}
@Override
public void fn_2 () {
vl_1 = 0xffffffff ;
...
@Override
public void fn_3 ( final byte [] vr_2 , int vr_3 , int vr_4 ) {
int vr_5 = vl_1 ;
while( vr_4 > 7 ) {
final int vr_6 = ( vr_2 [ vr_3 + 0 ] ^ vr_5 ) & 0xff ;
...
( vr_10 [ vl_8 + vr_13 ] ^ vr_10 [ vl_9 + vr_14 ] ) ;
vr_3 += 8 ;
vr_4 -= 8 ;
}
switch( vr_4 ) {
...
@Override
final public void fn_3 ( final int vr_2 ) {
