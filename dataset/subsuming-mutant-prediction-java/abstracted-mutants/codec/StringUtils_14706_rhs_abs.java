...
if ( vr_1 instanceof String && vr_2 instanceof String ) { MST[RemoveConditionalMutator_EQUAL_ELSE]MSP[N]
return vr_1 . equals ( vr_2 ) ;
}
return vr_1 . length () == vr_2 . length () && vr_3 . vr_4 ( vr_1 , false , 0 , vr_2 , 0 , vr_1 . length () ) ;
}
