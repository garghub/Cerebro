...
return vl_1 == null ? false : vl_1 . contains ( vr_1 ) ;
}
@Override
...
int vr_5 = vr_3 + 2 ;
boolean vr_6 = false ;
final char vr_7 = vr_2 . charAt ( vr_5 ) ;
if( vr_7 == 'x' || vr_7 == 'X' ) {
vr_5 ++ ;
vr_6 = true ;
if( vr_5 == vr_4 ) {
...
final boolean vr_9 = vr_8 != vr_4 && vr_2 . charAt ( vr_8 ) == ';' ;
if( ! vr_9 ) {
if( fn_1 ( tp_1 . vr_10 ) ) {
return 0 ;
} else
...
try {
if( vr_6 ) {
vr_12 = Integer . vr_13 ( vr_2 . vr_14 ( vr_5 , vr_8 ) . toString () , 16 ) ;
} else {
vr_12 = Integer . vr_13 ( vr_2 . vr_14 ( vr_5 , vr_8 ) . toString () , 10 ) ;
}
} catch( final tp_4 vr_15 ) {
return 0 ;
}
if( vr_12 > 0xFFFF ) {
final char [] vr_16 = vr_17 . vr_18 ( vr_12 ) ;
out . vr_19 ( vr_16 [ 0 ] ) ;
out . vr_19 ( vr_16 [ 1 ] ) ;
} else {
out . vr_19 ( vr_12 ) ;
