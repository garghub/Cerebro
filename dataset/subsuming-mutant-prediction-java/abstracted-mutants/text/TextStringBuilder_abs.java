...
public void fn_15 ( final int vr_10 , final int vr_11 , final char [] vr_13 ,
final int vr_14 ) {
if ( vr_10 < 0 ) {
...
if ( vr_33 ) {
fn_7 ( size + vl_7 ) ;
System . vr_6 ( vr_4 , vr_7 , vr_4 , vr_7 + vl_7 , size - vr_7 ) ;
vr_4 [ vr_7 ++ ] = 't' ;
vr_4 [ vr_7 ++ ] = 'r' ;
vr_4 [ vr_7 ++ ] = 'u' ;
vr_4 [ vr_7 ] = 'e' ;
...
fn_7 ( size + vl_8 ) ;
System . vr_6 ( vr_4 , vr_7 , vr_4 , vr_7 + vl_8 , size - vr_7 ) ;
vr_4 [ vr_7 ++ ] = 'f' ;
vr_4 [ vr_7 ++ ] = 'a' ;
vr_4 [ vr_7 ++ ] = 'l' ;
vr_4 [ vr_7 ++ ] = 's' ;
...
private void fn_32 ( final int vr_10 , final int vr_11 , final int vr_53 , final String vr_54 ,
final int vr_55 ) {
...
public tp_1 fn_31 ( final tp_3 vr_52 , final String vr_56 , final int vr_10 ,
int vr_11 , final int vr_61 ) {
vr_11 = fn_14 ( vr_10 , vr_11 ) ;
return fn_32 ( vr_52 , vr_56 , vr_10 , vr_11 , vr_61 ) ;
}
private tp_1 fn_32 ( final tp_3 vr_52 , final String vr_56 , final int vr_62 , int vr_63 ,
int vr_61 ) {
...
lb_1: for ( int vr_3 = vr_10 ; vr_3 < vr_12 ; vr_3 ++ ) {
...
lb_1: for ( int vr_3 = vr_10 - strLen + 1 ; vr_3 >= 0 ; vr_3 -- ) {
for ( int vr_71 = 0 ; vr_71 < strLen ; vr_71 ++ ) {
...
return vr_24 instanceof tp_1 && equals ( ( tp_1 ) vr_24 ) ;
}
@Override
public int fn_53 () {
final char [] vr_21 = vr_4 ;
...
if ( vr_82 < 0 || vr_12 < 0 || vr_82 > vr_81 . length || ( vr_82 + vr_12 ) > vr_81 . length || ( vr_82 + vr_12 ) < 0 ) {
throw new fn_61 () ;
}
if ( vr_12 == 0 ) {
return 0 ;
