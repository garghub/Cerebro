...
if ( ! ( vr_9 == null || vr_7 < 0 || vr_9 . length () <= vr_7 ) ) {
throw new IllegalArgumentException (
String . vr_2 ( lr_1 ,
vr_9 ,
vr_7 ) ) ;
}
final StringBuilder vr_10 = new StringBuilder ( vr_3 ) ;
...
vr_10 . vr_12 ( vr_7 - vr_11 . length () , vr_3 . length () , vr_11 . toString () ) ;
}
final boolean vr_13 = ( vr_5 & vl_2 ) == vl_2 ;
for ( int vr_14 = vr_10 . length () ; vr_14 < vr_6 ; vr_14 ++ ) {
vr_10 . vr_15 ( vr_13 ? vr_14 : 0 , vr_8 ) ;
}
vr_4 . vr_2 ( vr_10 . toString () ) ;
return vr_4 ;
}
